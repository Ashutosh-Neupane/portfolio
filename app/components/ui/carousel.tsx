...
export default function Carousel({ slides }: CarouselProps) {
  ...
  const handlePreviousClick = () => {
    // Ensure the first slide goes to the last slide
    const previous = current === 0 ? slides.length - 1 : current - 1;
    setCurrent(previous);
  };

  const handleNextClick = () => {
    // Ensure the last slide goes to the first slide
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 flex justify-center w-full py-4 z-20">
        <CarouselControl
          type="previous"
